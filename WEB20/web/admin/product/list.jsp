...
<HEAD>
    ...
    <script type="text/javascript">
        ...
        function delProduct(pid) {
            ...
            if(isDel){
                location.href="${pageContext.request.contextPath}/deleteAdminProduct?pid="+pid;
            }
        }
        $(function () {
...
<body>
<br>
<form id="Form1" name="Form1" action="${pageContext.request.contextPath}/selectAdminProduct" method="post">


    商品名称<input type="text" value="${condition.pname}" name="pname">&nbsp;&nbsp;
                ...
                <table cellspacing="0" cellpadding="1" rules="all"
                    ...
                    <c:forEach items="${productList}" var="product" varStatus="Status">
                        ...
                        <tr onmouseover="this.style.backgroundColor = 'white'"
                            ...
                            <td style="CURSOR: hand; HEIGHT: 22px" align="center"
                                width="17%">${product.is_hot==1?"是":"否"}
                            </td>
                            <td align="center" style="HEIGHT: 22px"><a
                                    href="${pageContext.request.contextPath }/editAdminProduct?pid=${product.pid}">
                                <img
